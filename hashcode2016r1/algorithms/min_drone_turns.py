...
from .tools import get_delivery_with_min_turns, get_intermediate_delivery_with_min_turns


class MinDroneTurnsAlgorithm(Algorithm):
    """
    Deliver the orders with the minimal drone-movement-first.
    """

    def __init__(self, data_dict, angle_threshold=45.0):
        super(MinDroneTurnsAlgorithm, self).__init__(data_dict)
        self.angle_threshold = angle_threshold

    def pre_process(self):
        super(MinDroneTurnsAlgorithm, self).pre_process()
