...
from .tools import get_delivery_with_min_weight, get_intermediate_delivery_with_min_turns


class OrderWeightFirstAlgorithm(Algorithm):
    """
    Delivers the orders with the least total weight first.
    """

    def __init__(self, data_dict, angle_threshold=45.0):
        super(OrderWeightFirstAlgorithm, self).__init__(data_dict)
        self.angle_threshold = angle_threshold

    def pre_process(self):
        super(OrderWeightFirstAlgorithm, self).pre_process()
    ...
    def generate(self):
        ...
        while True:
            ...
            this_delivery = get_delivery_with_min_weight(this_drone, order_list, warehouse_list, data_dict)
